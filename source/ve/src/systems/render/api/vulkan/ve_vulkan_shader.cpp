...
PlatformShader::PlatformShader(VkDevice device_handle,
                               ...
                               const VkPipelineShaderStageCreateInfo& shader_stage_info) : VkRc<vk::Rc::shader_module>(shader_module_handle,
                                                                                                                   device_handle)
...
{
	switch (static_cast<Shader::Stage>(shader_type))
	{
	case Shader::Stage::vertex: return VK_SHADER_STAGE_VERTEX_BIT;
	case Shader::Stage::hull: return VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT;
	case Shader::Stage::domain: return VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT;
	case Shader::Stage::geometry: return VK_SHADER_STAGE_GEOMETRY_BIT;
	case Shader::Stage::pixel: return VK_SHADER_STAGE_FRAGMENT_BIT;
