	                                                    ...
	                                                    theme)
{
	...
	for (ut::uint32 i = 0; i < variant_count; i++)
	{
		...
		ut::UniquePtr<Button> variant_button = ut::MakeUnique<Button>(x_offset,
		                                                              ...
		                                                              variant_height,
		                                                              variants[i]);
		variant_button->SetBackgroundColor(Button::State::release, ConvertToFlColor(theme.background_color));
		variant_button->SetBackgroundColor(Button::State::push, ConvertToFlColor(theme.button_push_color));
		variant_button->SetBackgroundColor(Button::State::hover, ConvertToFlColor(theme.button_hover_color));
